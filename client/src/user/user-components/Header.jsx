...
function Header() {
  ...
  return (
    ...
    <div className="flex justify-center h-4/5 ">
        ...
        >
           <div className='w-96 my-20 mx-20'> 
                <p className='text-6xl text-'>Air, Sleep, Dream</p>
                <p className='text-xl my-6'>Find and book your dream destination.</p>
                <button className='bg-blue-500 text-white px-6 py-2 rounded-full mb-40'>Start your search.</button>
           </div>
        </div>
      </div>
      <div className='bg-white rounded-2xl shadow-xl shadow-gray-200 p-10 w-94 mx-60 h-30 transform translate-y-[-80px] flex justify-around'>
        <div>
